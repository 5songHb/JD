/*
东东工厂，仅仅只运行10秒一个的电量，每天晚上1点到7点运行，解决常见夜间网络问题
...
function taskPostUrl(function_id) {
  let url = `${JD_API_HOST}`;
  console.log(url);
  console.log(`functionId=${function_id}&body={}&client=wh5&clientVersion=1.0.0`);
  return {
    url,
    body: `functionId=${function_id}&body={}&client=wh5&clientVersion=1.0.0`,
    headers: {
      ...
      "User-Agent": "jdapp;android;9.3.2;9;864688031947275-9487e0601502;network/4g;model/MI 6X;addressid/0;aid/0b90192af742eb32;oaid/6b45cefde072707;osVer/28;appBuild/86083;partner/jdtopc;jdSupportDarkMode/0;Mozilla/5.0 (Linux; Android 9; MI 6X Build/PKQ1.180904.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.72 MQQBrowser/6.2 TBS/046140 Mobile Safari/537.36",
    },
    timeout: 10000,
  }
}
